...
function App() {
  ...
  const [pollutant, setPollutant] = useState('_pm10');
  ...
  const handleReset = () => {
    ...
    setSelectedProvinces([]); // Reset della selezione delle province
  };
            ...
            <Grid item xs={2.3}>
              <Item className="Item">
                ...
                <div style={{ minHeight: '30px', marginTop: '-10px' }}>
                  {selectedRegion && <p>Selected Region:<br /><b>{selectedRegion}</b></p>}
                </div>
